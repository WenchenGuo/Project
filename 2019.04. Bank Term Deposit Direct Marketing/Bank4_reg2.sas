...
proc reg data=bank.sdtrain2 outest=estfile;
	score: model Good=pdays1--pdays2 age1--age2 campaign1--campaign3 
		...
		euribor3m1--euribor3m4 nr_employed1 day_of_week1--day_of_week3 job1--job4 
		marital1--marital3 education1--education2 education4 default1 
		housing1--housing2 loan1 contact1 month1--month5 poutcome1;
	run;
quit;
